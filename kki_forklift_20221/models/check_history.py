...
class kki_forklift_check_history(models.Model):
    ...
    lift_id = fields.Many2one("kki_forklift_20221.lift", "Forklift")
    ...
    def _get_last_date(self):
        if self.lift_id.last_check_date:
            if self.lift_id.last_check_date > self.check_date:
                ...
                self.env['kki_forklift_20221.lift'].search([('id', '=', self.lift_id._origin.id), ]).write({
    ...
    def action_save(self):
        ...
        return {
            ...
            'res_model': 'kki_forklift_20221.lift',  # 遷移先のモデル名
